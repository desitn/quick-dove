## 0.2.8 / 2026-08-23
  * 日志查看器表格视图(CSV/TSV)优化：分页加载、表头固定、列宽可调/折叠、水平滚动
  * 长数据列宽上限放大，悬停行/单元格可查看完整内容

## 0.2.7 / 2026-07-10
  * 集成串口调试工具（Quick Serial）
  * 修复设备列表不显示与扫描端口问题
  * 修复下载口检测与超时逻辑
  * 优化固件目录探测与 AT 命令集加载
  * 代码模块化重构
...
## 0.2.3 / 2025-12-15
  * add build button in status bar for firmware generate.

## 0.2.2 / 2025-12-10
  * init version, support (RTOS) platform:
